...
/// [CustomizedNyLanguageSwitcher] is a widget that allows you to switch languages in your app.
/// You can use it in the [AppBar] or as a bottom sheet modal using the [showBottomModal] method.
/// Example:
/// ```dart
/// CustomizedNyLanguageSwitcher()
/// // or
/// CustomizedNyLanguageSwitcher.showBottomModal(context);
/// ```
/// You can also use the [CustomizedNyLanguageSwitcher.currentLanguage] method to get the current language.
/// Example:
/// ```dart
/// Map<String, dynamic>? lang = await CustomizedNyLanguageSwitcher.currentLanguage();
/// ```
/// You can also use the [CustomizedNyLanguageSwitcher.storeLanguage] method to store the language.
/// Example:
/// ```dart
/// CustomizedNyLanguageSwitcher.storeLanguage(object: {"en": "English"});
/// ```
class CustomizedNyLanguageSwitcher extends StatefulWidget {
  CustomizedNyLanguageSwitcher(
      {Key? key,
      this.icon,
  ...
  static Map<String, String>? getLanguageData(String localeCode) {
    ...
    MapEntry<String, String>? data =
        languageData.entries.firstWhere((element) => element.key == localeCode);
    if (data == null) {
      return null;
    }
  ...
  @override
  createState() => _CustomizedNyLanguageSwitcherState();
}

class _CustomizedNyLanguageSwitcherState
    extends NyState<CustomizedNyLanguageSwitcher> {
  Map<String, dynamic>? selectedLanguage;
  List<Map<String, String>> languages = [];

  _CustomizedNyLanguageSwitcherState() {
    stateName = CustomizedNyLanguageSwitcher.state;
  }

  @override
  boot() async {
    languages = await CustomizedNyLanguageSwitcher.getLanguageList();
    selectedLanguage = await CustomizedNyLanguageSwitcher.currentLanguage();
  }
  ...
  _onChange(String? newLanguageCode) async {
    ...
    selectedLanguage =
        CustomizedNyLanguageSwitcher.getLanguageData(newLanguageCode);
    ...
    // store the language
    await CustomizedNyLanguageSwitcher.storeLanguage(object: selectedLanguage);
